      Program prgm_01_01
!
!     This program reads a 3x3 matrix from a user-provided input file.
!     After the
...
!
!     This subroutine prints a 3x3 real matrix. The output is written to
!     StdOut.
!
      implicit none
...
!     Do the printing job.
!
      Print*,'Programed By Ajay Khanna'
      print*
